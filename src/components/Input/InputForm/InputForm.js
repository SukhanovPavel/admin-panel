...
export const InputForm = ({
    ...
    return (
        <form className={styles.wrapper}>
            <label type="text" className={styles.topText}>
                Дата и время заказа
            </label>
            <div className={inputStyles}>
                <input type="text" className={styles.inp} placeholder={placeholder} value={value}></input>
                <button type="button" value="&#215;" className={styles.x}>
